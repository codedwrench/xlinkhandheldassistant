...
TEST_F(XLinkKaiConnectionTest, TestReceiverThreadMonitorData)
{
    ...
    EXPECT_CALL(*mSocketWrapperMock, PollThread()).WillRepeatedly(Invoke([&] {
        ...
        if (lThreadCallCount == 1) {
            ...
            // Type (0x88 0xc8)
            // For some reason clang format puts all of these values vertically
            // clang-format off
            std::array<unsigned char, 48> lMonitor{0x00, 0x00, 0x10, 0x00, 0x0e, 0x80, 0x00, 0x00, 0x02, 0x30, 0x6c,
                0x09, 0xc0, 0x00, 0x08, 0x00, 0x08, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x18,
                0xf8, 0x29, 0x3f, 0xb0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xaa, 0xaa, 0x03, 0x00, 0x00, 
                0x00, 0x88, 0xc8};
            // clang-format on
